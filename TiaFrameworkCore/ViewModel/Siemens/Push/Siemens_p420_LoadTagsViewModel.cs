...
{
    public partial class Siemens_p420_LoadTagsViewModel : BaseViewModel
    {
        #region Fields
        ...
        #region ctr
        public Siemens_p420_LoadTagsViewModel(ICoreServices coreServices, IJsonService jsonService, IS7Lgc s7Lgc, IDirectoryService directoryService) : base(coreServices)
        {
