...
{
    public partial class Siemens_p300_NetConfigViewModel : BaseViewModel
    {
        ...
        public Siemens_p300_NetConfigViewModel(ICoreServices coreServices, IS7Lgc s7Lgc) : base(coreServices)
        {
            _S7Lgc = s7Lgc;
