...
namespace TiaFrameworkCore.Siemens._30_Lgc
{
    public class S7Com:IS7Com
    {
        ...
        #region ctr
        public S7Com(INotificationService notificationservice)
        {
        ...
        public OperationResult Connect(S7NetConfig HwConfig)
        {
                ...
                CyclicRefresh();
            return new OperationResult(result, message, IsOnline);
        }
        ...
        public void RefreshTagsTask()
        {
            ...
            catch(Exception ex) 
            {
                InterruptRefreshCom.StopAsync();
                Disconnect();
                _NotificationService.UpdateMessage(ex.Source+"| "+ ex.Message, true);
            }
        }
